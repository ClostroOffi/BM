...
class ProcessBuilder {
    ...
    _constructJVMArguments112(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=BlockMon Launcher')
            args.push('-Xdock:icon=app/assets/images/LogoTopaze.png' + path.join(__dirname, '/app/assets/images/LogoTopaze.png'))
        }
    ...
    _constructJVMArguments113(mods, tempNativePath){
        ...
        if(process.platform === 'darwin'){
            args.push('-Xdock:name=BlockMon Launcher')
            args.push('-Xdock:icon=app/assets/images/icon.ico' + path.join(__dirname, '/app/assets/images/LogoTopaze.png'))
        }
        args.push('-Xmx' + ConfigManager.getMaxRAM())
        args.push('-Xms' + ConfigManager.getMinRAM())
        args = args.concat(ConfigManager.getJVMOptions())
