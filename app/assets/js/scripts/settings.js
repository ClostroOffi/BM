        ...
        val.onclick = (e) => {
            ...
            if(Object.keys(ConfigManager.getAuthAccounts()).length === 1){
                ...
                setOverlayContent(
                    ...
                    'Pour utiliser le launcher, vous devez être au moins connecté à un compte. Vous devrez vous reconnecter plus tard.<br><br>Êtes-vous sûr de vouloir vous deconnecter ?',
                    'Je suis sûr',
                    'Annuler'
                )
                setOverlayHandler(() => {
