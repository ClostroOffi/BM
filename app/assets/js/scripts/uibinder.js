...
async function validateSelectedAccount(){
    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                'Impossible de nous connecter à votre compte',
                `Connexion au compte <strong>${selectedAcc.displayName}</strong> impossible. Veuillez ${accLen > 0 ? 'sélectionner un autre compte ou ' : ''} vous reconnecter.`,
                'Se reconnecter',
                'Selectionner un autre compte'
            )
            setOverlayHandler(() => {
